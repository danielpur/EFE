...
<body>
    ...
    <div id="contenedorBoleta">
        ...
        <label class="badge-boleta badge bg-info text-dark">Total Compra <span id="totalCompra">0</span></label>
        <label class="badge-boleta badge bg-info text-dark">Total Productos <span id="totalProductos">0</span></label>

    </div>
    <div id="contendorAccionesCompra">
